...
RTC::ReturnCode_t Vouce_output_ver2::onExecute(RTC::UniqueId ec_id)
{
	...
	if (m_Command_inIn.isNew())
	{
		...
		if (m_select_language == 1)
		{
			...
			{
				printf("Robot sate: Going_forward\n");
