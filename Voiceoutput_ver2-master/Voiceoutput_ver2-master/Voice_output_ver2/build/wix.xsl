...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/wix:Wix">
    <Wix xmlns="http://schemas.microsoft.com/wix/2006/wi">
      <Product xmlns="http://schemas.microsoft.com/wix/2006/wi" Id="920A322F-3229-4DE5-849E-B29F3678043C" Name="Vouce_output_ver2 " Language="1041" Codepage="932" Version="" Manufacturer="IidaYuki" UpgradeCode="0FC046B7-0D10-4E56-8274-447E403F7924">
        <Package InstallerVersion="300" Compressed="yes" Languages='1041' SummaryCodepage='932' />
        <Media Id="1" Cabinet="Vouce_output_ver2.cab" EmbedCab="yes" />
	  ...
	  -->
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\bin\Vouce_output_ver2.dll','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\lib\Vouce_output_ver2.lib','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\bin\Vouce_output_ver2Comp.exe','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, 'RTC.xml')]" />
        </Feature>
	...
	<!-- <Feature Id="SOURCES" Title="" Level="1" Absent="allow" Description="" >-->
          <!-- Start Ripping through the xml -->
	  <!-- <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, 'Vouce_output_ver2100\src')]" /> -->
	  <!-- </Feature> -->
        ...
        <!-- 
        <WixVariable Id="WixUILicenseRtf" Value="C:/Users/robo-lab/Desktop/Voiceoutput_ver2-master/Voiceoutput_ver2-master/Voice_output_ver2/cmake/License.rtf"/>
        -->
